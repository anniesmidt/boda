...
class WDSViewSliders_wds {
  ...
  public function display() {
    ...
    <form class="wrap" id="sliders_form" method="post" action="admin.php?page=sliders_wds" style="width: 99%;" enctype="multipart/form-data">
      ...
      <div class="buttons_div">
        ...
        <input type="button" class="button-secondary" onclick="wds_export()" value="Export" />
        <input type="button" class="button-secondary" onclick="wds_import()" value="Import" />
      ...
      <div class="wds_opacity_import" onclick="jQuery('.wds_opacity_import').hide();jQuery('.wds_import').hide();"></div>
      <div class="wds_import">
        ...
        <input type="button" class="button-secondary" onclick="jQuery('.wds_import').hide();jQuery('.wds_opacity_import').hide(); return false;" value="Cancel" />
  ...
  public function edit($id, $reset = FALSE) {
    ...
    <form class="wrap" method="post" id="sliders_form" action="admin.php?page=sliders_wds" style="width: 99%;">
      <?php wp_nonce_field('nonce_wd', 'nonce_wd'); ?>
      <span class="slider-icon"></span>
      ...
      <div class="wds_buttons" style="float: right; position: relative; z-index: 50;">
        ...
        ?>
        <a id="wds_posts_btn" href="<?php echo add_query_arg(array('action' => 'WDSPosts', 'slider_id' => $id, 'width' => '700', 'height' => '550', 'TB_iframe' => '1'), admin_url('admin-ajax.php')); ?>" class="button-secondary thickbox thickbox-preview" title="Add Posts" onclick="if (wds_check_required('name', 'Name')) {jQuery(this).removeClass('thickbox').removeClass('thickbox-preview');return false;};
        ...
        <input type="button" class="button-secondary" onclick="wds_export_one()" value="Export" />
      ...
      <div>
        ...
        <div class="wds_box wds_settings_box">
          ...
          <div>
                    ...
                    <td>
                      <select name="effect" id="effect">
                        ...
                        foreach ($effects as $key => $effect) {
                          ?>
                          <option value="<?php echo $key; ?>" <?php if ($row->effect == $key) echo 'selected="selected"'; ?>><?php echo $effect; ?></option>
                          <?php
                        }
                        ?>
                      </select>
                      <div class="spider_description">Select the effect which will be applied when shifting from one slider to another.</div>
                    </td>
                  </tr>
                  <tr>
            ...
            <div class="wds_nav_box wds_nav_carousel_box">
              <table>
                <tbody>
                  <tr>
                    <td class="spider_label"><label>Carousel: </label></td>
                    <td>
                      <input type="radio" id="carousel1" name="carousel" <?php echo (($row->carousel) ? 'checked="checked"' : ''); ?> value="1" /><label for="carousel1">Yes</label>
                      <input type="radio" id="carousel0" name="carousel" <?php echo (($row->carousel) ? '' : 'checked="checked"'); ?> value="0" /><label for="carousel0">No</label>
                  ...
                  <tr>
                    ...
                    <td>
                      <input type="text" id="carousel_image_counts" name="carousel_image_counts" value="<?php echo $row->carousel_image_counts; ?>" class="spider_int_input" onkeypress="return spider_check_isnum(event)" />
                  ...
                  <tr>
                    ...
                    <td>
                      <input type="text" id="carousel_image_parameters" name="carousel_image_parameters" value="<?php echo $row->carousel_image_parameters; ?>" class="spider_int_input" onkeypress="return spider_check_isnum(event)" />
                  ...
                  <tr>
                    ...
                    <td>
                      <input type="radio" id="carousel_fit_containerWidth1" name="carousel_fit_containerWidth" <?php echo (($row->carousel_fit_containerWidth) ? 'checked="checked"' : ''); ?> value="1" /><label for="carousel_fit_containerWidth1">Yes</label>
                      <input type="radio" id="carousel_fit_containerWidth0" name="carousel_fit_containerWidth" <?php echo (($row->carousel_fit_containerWidth) ? '' : 'checked="checked"'); ?> value="0" /><label for="carousel_fit_containerWidth0">No</label>
                      <div class="spider_description"></div>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <input type="text" id="carousel_width" name="carousel_width" value="<?php echo $row->carousel_width; ?>" class="spider_int_input" onkeypress="return spider_check_isnum(event)" /> px
                      <div class="spider_description"></div>
                    </td>
                  </tr>
                </tbody>
                ...
                <tbody>
                    ...
                    <td>
                      <div style="display: table;">
                        <div style="display: table-cell; vertical-align: middle;">
                          ...
                          if (!$row->spider_uploader) {
                            ?>
                          <input class="button-primary wds_ctrl_btn_upload" type="button" onclick="spider_media_uploader('nav_left_but', event, false); return false;" value="Previous Button" />
                            <?php
                          }
                          else {
                            ?>
                          <a href="<?php echo add_query_arg(array('action' => 'addImage', 'width' => '700', 'height' => '550', 'extensions' => 'jpg,jpeg,png,gif', 'callback' => 'wds_add_image', 'image_for' => 'nav_left_but', 'dir' => '/arrows', 'TB_iframe' => '1'), admin_url('admin-ajax.php')); ?>" class="button-primary thickbox thickbox-preview wds_ctrl_btn_upload" title="Add Image" onclick="return false;">
                          Previous Button
                          </a> 
                            <?php
                          }
                          ...
                          if (!$row->spider_uploader) {
                            ?>
                          <input class="button-primary wds_ctrl_btn_upload" type="button" onclick="spider_media_uploader('nav_left_hov_but', event, false); return false;" value="Previous Button Hover" />
                            <?php
                          }
                          else {
                            ?>
                          <a href="<?php echo add_query_arg(array('action' => 'addImage', 'width' => '700', 'height' => '550', 'extensions' => 'jpg,jpeg,png,gif', 'callback' => 'wds_add_image', 'image_for' => 'nav_left_hov_but', 'dir' => '/arrows', 'TB_iframe' => '1'), admin_url('admin-ajax.php')); ?>" class="button-primary thickbox thickbox-preview wds_ctrl_btn_upload" title="Add Image" onclick="return false;">
                        ...
                        <div style="display: table-cell; vertical-align: middle;">
                          ...
                          if (!$row->spider_uploader) {
                            ?>
                          <input class="button-primary wds_ctrl_btn_upload" type="button" onclick="spider_media_uploader('nav_right_but', event, false); return false;" value="Next Button" />
                            <?php
                          }
                          else {
                            ?>
                          <a href="<?php echo add_query_arg(array('action' => 'addImage', 'width' => '700', 'height' => '550', 'extensions' => 'jpg,jpeg,png,gif', 'callback' => 'wds_add_image', 'image_for' => 'nav_right_but', 'dir' => '/arrows', 'TB_iframe' => '1'), admin_url('admin-ajax.php')); ?>" class="button-primary thickbox thickbox-preview wds_ctrl_btn_upload" title="Add Image" onclick="return false;">
                          Next Button
                          </a>
                            <?php
                          }
                          ...
                          if (!$row->spider_uploader) {
                            ?>
                          <input class="button-primary wds_ctrl_btn_upload" type="button" onclick="spider_media_uploader('nav_right_hov_but', event, false); return false;" value="Next Button Hover" />
                            <?php
                          }
                          else {
                            ?>
                          <a href="<?php echo add_query_arg(array('action' => 'addImage', 'width' => '700', 'height' => '550', 'extensions' => 'jpg,jpeg,png,gif', 'callback' => 'wds_add_image', 'image_for' => 'nav_right_hov_but', 'dir' => '/arrows', 'TB_iframe' => '1'), admin_url('admin-ajax.php')); ?>" class="button-primary thickbox thickbox-preview wds_ctrl_btn_upload" title="Add Image" onclick="return false;">
                          Next Button Hover
                          </a>
                            <?php
                          }
                  ...
                  <tr id="right_left_butt_select">
                    ...
                    <td style="display: block;">
                      <div style="display: table; margin-bottom: 14px;">
                        ...
                        <div style="display:table-cell;vertical-align: middle;">
                          <div style="display: block; width: 180px; margin-left: 12px;">
                            <div class="spider_choose_option" onclick="wds_choose_option_color(this)">
                      ...
                      <div class="spider_description">Choose the type and color for navigation button images.</div>
                    </td>
                  </tr>
                    ...
                    <td>
                      <div style="display: table;">
                        <div style="display: table-cell; vertical-align: middle;">
                          ...
                          if (!$row->spider_uploader) {
                            ?>
                          <input class="button-primary wds_ctrl_btn_upload" type="button" onclick="spider_media_uploader('play_but', event, false); return false;" value="Play Button" />
                            <?php
                          }
                          else {
                            ?>
                          <a href="<?php echo add_query_arg(array('action' => 'addImage', 'width' => '700', 'height' => '550', 'extensions' => 'jpg,jpeg,png,gif', 'callback' => 'wds_add_image', 'image_for' => 'play_but', 'dir' => '/arrows', 'TB_iframe' => '1'), admin_url('admin-ajax.php')); ?>" class="button-primary thickbox thickbox-preview wds_ctrl_btn_upload" title="Add Image" onclick="return false;">
                          Play Button
                          </a> 
                            <?php
                          }
                          ...
                          if (!$row->spider_uploader) {
                            ?>
                          <input class="button-primary wds_ctrl_btn_upload" type="button" onclick="spider_media_uploader('play_hov_but', event, false); return false;" value="Play Button Hover" />
                            <?php
                          }
                          else {
                            ?>
                          <a href="<?php echo add_query_arg(array('action' => 'addImage', 'width' => '700', 'height' => '550', 'extensions' => 'jpg,jpeg,png,gif', 'callback' => 'wds_add_image', 'image_for' => 'play_hov_but', 'dir' => '/arrows', 'TB_iframe' => '1'), admin_url('admin-ajax.php')); ?>" class="button-primary thickbox thickbox-preview wds_ctrl_btn_upload" title="Add Image" onclick="return false;">
                          Play Button Hover
                          </a> 
                            <?php
                          }
                        ...
                        <div style="display: table-cell; vertical-align: middle;">
                          ...
                          if (!$row->spider_uploader) {
                            ?>
                          <input class="button-primary wds_ctrl_btn_upload" type="button" onclick="spider_media_uploader('paus_but', event, false); return false;" value="Pause Button" />
                            <?php
                          }
                          else {
                            ?>
                          <a href="<?php echo add_query_arg(array('action' => 'addImage', 'width' => '700', 'height' => '550', 'extensions' => 'jpg,jpeg,png,gif', 'callback' => 'wds_add_image', 'image_for' => 'paus_but', 'dir' => '/arrows', 'TB_iframe' => '1'), admin_url('admin-ajax.php')); ?>" class="button-primary thickbox thickbox-preview wds_ctrl_btn_upload" title="Add Image" onclick="return false;">
                          Pause Button
                          </a>
                            <?php
                          }
                          ...
                          if (!$row->spider_uploader) {
                            ?>
                          <input class="button-primary wds_ctrl_btn_upload" type="button" onclick="spider_media_uploader('paus_hov_but', event, false); return false;" value="Pause Button Hover" />
                            <?php
                          }
                          else {
                            ?>
                          <a href="<?php echo add_query_arg(array('action' => 'addImage', 'width' => '700', 'height' => '550', 'extensions' => 'jpg,jpeg,png,gif', 'callback' => 'wds_add_image', 'image_for' => 'paus_hov_but', 'dir' => '/arrows', 'TB_iframe' => '1'), admin_url('admin-ajax.php')); ?>" class="button-primary thickbox thickbox-preview wds_ctrl_btn_upload" title="Add Image" onclick="return false;">
                          Pause Button Hover
                          </a>
                            <?php
                          }
                  ...
                  <tr id="play_pause_butt_select">
                    ...
                    <td style="display: block;">
                        <div style="display: table; margin-bottom: 14px;">
                          ...
                          <div style="display:table-cell;vertical-align: middle;">
                            <div style="display: block; width: 180px; margin-left: 12px;">
                              <div class="spider_choose_option" onclick="wds_choose_pp_option_color(this)">
                                <div  class="spider_option_main_title">Choose color</div>
                                <div class="spider_sel_option_ic"><i class="fa fa-angle-down fa-lg" style="color:#1E8CBE"></i></div>
                              </div>
                  ...
                  <tr id="tr_butts_color">
                    ...
                    <td>
                      <input type="text" name="butts_color" id="butts_color" value="<?php echo $row->butts_color; ?>" class="color" onchange="jQuery('#wds_left_style,#wds_right_style,#wds_play_style,#wds_paus_style').css({color: '#' + jQuery(this).val()})" />
                ...
                <tbody>
                  ...
                  <tr id="bullets_style">
                    ...
                    <td>
                      <div style="display: table;">
                        <div style="display: table-cell; vertical-align: middle;">
                          <select name="bull_style" id="bull_style" onchange="change_bull_style(jQuery(this).val())">
                            <?php
                    ...
                    <td>
                      <div style="display: table;">
                        <div style="display: table-cell; vertical-align: middle;">
                          ...
                          if (!$row->spider_uploader) {
                            ?>
                          <input class="button-primary wds_ctrl_btn_upload" type="button" onclick="spider_media_uploader('bullets_main_but', event, false); return false;" value="Active Button" />
                            <?php
                          }
                          else {
                            ?>
                          <a href="<?php echo add_query_arg(array('action' => 'addImage', 'width' => '700', 'height' => '550', 'extensions' => 'jpg,jpeg,png,gif', 'callback' => 'wds_add_image', 'image_for' => 'bullets_main_but', 'dir' => '/arrows', 'TB_iframe' => '1'), admin_url('admin-ajax.php')); ?>" class="button-primary thickbox thickbox-preview wds_ctrl_btn_upload" title="Add Image" onclick="return false;">
                          Active Button
                          </a> 
                            <?php
                          }
                        ...
                        <div style="display: table-cell; vertical-align: middle;">
                          ...
                          if (!$row->spider_uploader) {
                            ?>
                          <input class="button-primary wds_ctrl_btn_upload" type="button" onclick="spider_media_uploader('bullets_hov_but', event, false); return false;" value="Deactive Button" />
                            <?php
                          }
                          else {
                            ?>
                          <a href="<?php echo add_query_arg(array('action' => 'addImage', 'width' => '700', 'height' => '550', 'extensions' => 'jpg,jpeg,png,gif', 'callback' => 'wds_add_image', 'image_for' => 'bullets_hov_but', 'dir' => '/arrows', 'TB_iframe' => '1'), admin_url('admin-ajax.php')); ?>" class="button-primary thickbox thickbox-preview wds_ctrl_btn_upload" title="Add Image" onclick="return false;">
                          Deactive Button 
                          </a> 
                            <?php
                          }
                  ...
                  <tr id="bullets_images_select">
                    ...
                    <td style="display: block;">
                      <div style="display: table; margin-bottom: 14px;">
                        ...
                        <div style="display: table-cell; vertical-align: middle;">
                          <div style="display: block; width: 180px; margin-left: 12px;">
                            <div class="spider_choose_option" onclick="wds_choose_bull_option_color(this)" >
                              <div class="spider_option_main_title" >Choose color</div>
                              <div class="spider_sel_option_ic"><i class="fa fa-angle-down fa-lg" style="color: #1E8CBE;"></i></div>
                            </div>
                      ...
                      <div class="spider_description">Choose the type and color for the bullets.</div>
                    </td>
                  </tr>
                  <tr id="bullet_size">
            ...
            <div class="wds_nav_box wds_nav_filmstrip_box">
              <table>
                <tbody>
                  <tr>
                    <td class="spider_label"><label>Enable filmstrip: </label></td>
                    <td>
                      <input type="radio" id="enable_filmstrip1" name="enable_filmstrip" <?php echo (($row->enable_filmstrip) ? 'checked="checked"' : ''); ?> value="1" /><label for="enable_filmstrip1">Yes</label>
                      <input type="radio" id="enable_filmstrip0" name="enable_filmstrip" <?php echo (($row->enable_filmstrip) ? '' : 'checked="checked"'); ?> value="0" /><label for="enable_filmstrip0">No</label>
                  ...
                  <tr id="filmstrip_position">
                    <td class="spider_label"><label>Position: </label></td>
                    <td>
                      <select name="film_pos" id="film_pos">
                  ...
                  <tr id="filmstrip_size">
                    ...
                    <td>
                      <input type="text" name="film_thumb_width" id="film_thumb_width" value="<?php echo $row->film_thumb_width; ?>" class="spider_int_input" onkeypress="return spider_check_isnum(event)" /> x 
                      <input type="text" name="film_thumb_height" id="film_thumb_height" value="<?php echo $row->film_thumb_height; ?>" class="spider_int_input" onkeypress="return spider_check_isnum(event)" /> px
                  ...
                  <tr>
                    ...
                    <td>
                      <input type="text" name="film_bg_color" id="film_bg_color" value="<?php echo $row->film_bg_color; ?>" class="color" />
                  ...
                  <tr id="filmstrip_thumb_margin">
                    ...
                    <td>
                      <input type="text" name="film_tmb_margin" id="film_tmb_margin" value="<?php echo $row->film_tmb_margin; ?>" class="spider_int_input" onkeypress="return spider_check_isnum(event)"/> px
                  ...
                  <tr>
                    ...
                    <td>
                      <input type="text" name="film_act_border_width" id="film_act_border_width" value="<?php echo $row->film_act_border_width; ?>" class="spider_int_input" onkeypress="return spider_check_isnum(event)"/> px
                      <select name="film_act_border_style" id="film_act_border_style">
                        <?php
                        foreach ($border_styles as $key => $border_style) {
                          ?>
                      ...
                      <input type="text" name="film_act_border_color" id="film_act_border_color" value="<?php echo $row->film_act_border_color; ?>" class="color"/>
                  ...
                  <tr>
                    ...
                    <td>
                      <input type="text" name="film_dac_transparent" id="film_dac_transparent" value="<?php echo $row->film_dac_transparent; ?>" class="spider_int_input" onkeypress="return spider_check_isnum(event)"/> %
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td colspan="4">
                            ...
                            <input type="button" class="button-primary" onclick="wds_add_video('<?php echo $slide_row->id; ?>')" value="Add Video" />
                            <a href="<?php echo add_query_arg(array('action' => 'WDSPosts', 'slide_id' => $slide_row->id, 'count' => 1, 'width' => '700', 'height' => '550', 'TB_iframe' => '1'), admin_url('admin-ajax.php')); ?>" class="button-secondary thickbox thickbox-preview" title="Add Post" onclick="if (wds_check_required('name', 'Name')) {jQuery(this).removeClass('thickbox').removeClass('thickbox-preview');return false;};
                                                                                                                                                                                                                                                                                            jQuery(this).addClass('thickbox').addClass('thickbox-preview'); return false;">
                              Add Post
                            </a>
                        ...
                        <tr>
                          <td colspan="4">
                            ...
                            if (!$row->spider_uploader) {
                              ?>
                            <input type="button" class="button-primary button button-small" onclick="wds_add_layer('image', '<?php echo $slide_row->id; ?>', ''); return false;" value="Add Image Layer" />
                              <?php
                            }
                            else {
                              ?>
                            <a href="<?php echo add_query_arg(array('action' => 'addImage', 'width' => '700', 'height' => '550', 'extensions' => 'jpg,jpeg,png,gif', 'callback' => 'wds_add_image', 'image_for' => 'add_layer', 'slide_id' => $slide_row->id, 'TB_iframe' => '1'), admin_url('admin-ajax.php')); ?>" class="button-primary button button-small thickbox thickbox-preview" title="Add Image Layer" onclick="return false;">
                              Add Image layer
                            </a>
                              <?php
                            }
                            ?>
                            <input type="button" class="button-primary button button-small" onclick="wds_add_video_layer('<?php echo $slide_row->id; ?>'); return false;" value="Add Video Layer" />
                            <input type="button" class="button-primary button button-small" onclick="wds_add_layer('social', '<?php echo $slide_row->id; ?>'); return false;" value="Add Social Button Layer" />
                          </td>
                        </tr>
                      </tbody>
                      <?php
                          ...
                          <tbody id="<?php echo $prefix; ?>_tbody">
                              ...
                              <td>
                                ...
                                <span style="display: table-cell;">
                                  ...
                                  foreach ($layer_effects_in as $key => $layer_effect_in) {
                                    ?>
                                    <option value="<?php echo $key; ?>" <?php if ($layer->layer_effect_in == $key) echo 'selected="selected"'; ?>><?php echo $layer_effect_in; ?></option>
                                    <?php
                                  }
                                  ?>
                                  </select>
                              ...
                              <td>
                                ...
                                <span style="display: table-cell;">
                                  ...
                                  foreach ($layer_effects_out as $key => $layer_effect_out) {
                                    ?>
                                    <option value="<?php echo $key; ?>" <?php if ($layer->layer_effect_out == $key) echo 'selected="selected"'; ?>><?php echo $layer_effect_out; ?></option>
                                    <?php
                                  }
                                  ?>
                                  </select>
                            ...
                            <tr class="wds_layer_tr" style="display: none;">
                              ...
                              <td>
                                ...
                                if (!$row->spider_uploader) {
                                  ?>
                                <input type="button" class="button-primary" id="button_image_url<?php echo $slide_row->id; ?>" onclick="wds_add_layer('image', '<?php echo $slide_row->id; ?>', '<?php echo $layer->id; ?>', '', '', 1); return false;" value="Edit Image" />
                                  <?php
                                }
                                else {
                                  ?>
                                <a href="<?php echo add_query_arg(array('action' => 'addImage', 'width' => '700', 'height' => '550', 'extensions' => 'jpg,jpeg,png,gif', 'callback' => 'wds_add_image', 'image_for' => 'add_update_layer', 'slide_id' => $slide_row->id, 'layer_id' => $layer->id, 'TB_iframe' => '1'), admin_url('admin-ajax.php')); ?>" class="button-primary thickbox thickbox-preview" title="Edit Image" onclick="return false;">
                                  Edit Image
                                </a>
                                  <?php
                                }
                            ...
                            <tr class="wds_layer_tr" style="display: none;">
                              ...
                              <td>
                                <input type="hidden" name="<?php echo $prefix; ?>_alt" id="<?php echo $prefix; ?>_alt" value="<?php echo $layer->alt; ?>"/>
                                <input type="hidden" name="<?php echo $prefix; ?>_link" id="<?php echo $prefix; ?>_link" value="<?php echo $layer->link; ?>"/>
                                <input type="hidden" name="<?php echo $prefix; ?>_image_url" id="<?php echo $prefix; ?>_image_url" value="<?php echo $layer->image_url; ?>" />
                                <input id="<?php echo $prefix; ?>_image_width" class="spider_int_input" type="text" onkeyup="wds_scale('#<?php echo $prefix; ?>_image_scale', '<?php echo $prefix; ?>')" value="<?php echo $layer->image_width; ?>" name="<?php echo $prefix; ?>_image_width" /> x 
                                <input id="<?php echo $prefix; ?>_image_height" class="spider_int_input" type="text" onkeyup="wds_scale('#<?php echo $prefix; ?>_image_scale', '<?php echo $prefix; ?>')" value="<?php echo $layer->image_height; ?>" name="<?php echo $prefix; ?>_image_height" /> px
                                <div class="spider_description">Set width and height of the video.</div>
                              </td>
                              <td class="spider_label">
                                <label for="<?php echo $prefix; ?>_layer_effect_in">Effect In:</label>
                              </td>
                            ...
                            <tr class="wds_layer_tr" style="display: none;">
                              ...
                              <td>
                                <input id="<?php echo $prefix; ?>_image_scale1" type="radio" name="<?php echo $prefix; ?>_image_scale" value="on" <?php echo (($layer->image_scale == "on") ? 'checked="checked"' : ''); ?> />
                                <label for="<?php echo $prefix; ?>_image_scale1">Yes</label>
                                <input id="<?php echo $prefix; ?>_image_scale0" type="radio" name="<?php echo $prefix; ?>_image_scale" value="off" <?php echo (($layer->image_scale == "on") ? '' : 'checked="checked"'); ?> />
                                <label for="<?php echo $prefix; ?>_image_scale0">No</label>
                                <div class="spider_description"></div>
                              </td>
                              <td class="spider_label">
                                <label for="<?php echo $prefix; ?>_shadow">Shadow: </label>
      ...
      <script>
        ...
        var wds_add_post_href = '<?php echo add_query_arg(array('action' => 'WDSPosts', 'count' => 1, 'width' => '700', 'height' => '550', 'TB_iframe' => '1'), admin_url('admin-ajax.php')); ?>';		
        jQuery(document).ready(function() {
          wds_onload();
        });
      ...
      <div class="opacity_add_image_url opacity_add_video wds_opacity_video wds_opacity_export"
           onclick="jQuery('.opacity_add_video').hide();
                    jQuery('.opacity_add_image_url').hide();
                    jQuery('.wds_exports').hide();"></div>
      ...
      <div class="wds_exports">
        <input type="checkbox" name="imagesexport" id="imagesexport" value="Images export" checked="checked" />
        <label for="imagesexport">Check the box to export the images included within sliders</label>
        <input class="button-secondary" type="button" id="wds_export_btn" data-href="<?php echo add_query_arg(array('action' => 'WDSExport'), admin_url('admin-ajax.php')); ?>" onclick="if (wds_check_required('name', 'Name')) {return false;}; spider_set_input_value('task', 'export_on'); spider_ajax_save('sliders_form', event); jQuery('.wds_exports').hide(); jQuery('.wds_opacity_export').hide();" value="Export" />
        <input type="button"  class="button-secondary" onclick="jQuery('.wds_exports').hide(); jQuery('.wds_opacity_export').hide(); return false;" value="Cancel" />
      </div>
    </form>
    <?php
