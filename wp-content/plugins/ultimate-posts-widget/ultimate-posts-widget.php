<?php
/*
Plugin Name: Boda Random Quote Sets
Description: A customized version of the Ultimate Posts Widget
Text Domain: upw
...
//remove update notices in plug-ins manager (updating this plugin will overwrite changes)
